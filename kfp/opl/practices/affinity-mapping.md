...
1. If you are brainstorming ideas, clearly state the objective of the brainstorm (a How Might We statement or Problem Statement). If you are synthesizing research data, collect all data and write each observation/data point on a separate sticky.
