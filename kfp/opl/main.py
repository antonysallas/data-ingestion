...
def run_standalone_mode(args):
    ...
    try:
        ...
        # Skip Elasticsearch ingestion unless explicitly enabled
        skip_es = not args.enable_es
        ...
        # Ingest documents into Elasticsearch only if explicitly enabled
        if not skip_es:
            ...
            _log.info("Elasticsearch ingestion is disabled (use --enable-es to enable it)")
